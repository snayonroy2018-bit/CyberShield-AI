...
import { Shield, Activity, Zap, AlertTriangle, BookOpen, Clock, FileText, User, LogOut, Lock } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-mono">
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                <Link
                  to="/register"
                  className="px-4 py-2 text-sm font-semibold text-black bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-cyan-300 hover:to-blue-400 rounded-lg shadow-neon transition-all duration-300"
                >
                  Register
                </Link>
              </div>
